...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'fidelizacion', 'user' => 'todasbd', 'password' => 'dragon01', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Elkanogroup/ProductosBundle/Resources/config/doctrine') => 'Elkanogroup\\ProductosBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Elkanogroup\\ProductosBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ProductosBundle' => 'Elkanogroup\\ProductosBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5179615e0b12acd085d862dc97aae4f0c9acf9312acf0ba3ab3bcf6065947516');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('contact_email', 'info@elkanogroup.com');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Elkanogroup/ProductosBundle/Resources/views'), 'Productos');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('02cc7e0209c7e0861f28069cdf06201d1eb64dda');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('567188ada0c871.69766238')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProductosBundle' => 'Elkanogroup\\ProductosBundle\\ProductosBundle',
            ...
            'secret' => '02cc7e0209c7e0861f28069cdf06201d1eb64dda',
            'locale' => 'en',
            ...
            'kernel.secret' => '02cc7e0209c7e0861f28069cdf06201d1eb64dda',
